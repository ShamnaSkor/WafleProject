...
declare class InventoryTypeAttributes {
    ...
    public armorHPBonusPercent: (ship: Wafle.Ship) => number;
    /** Shield HP Bonus Percent - represented in whole numbers (20% bonus as 20). */
    public shieldHPBonusPercent: (ship: Wafle.Ship) => number;
    public slotUsed: Wafle.FittingSlotType;
    ...
    public totalAlphaDamageActual(ship: Wafle.Ship, charge: Wafle.InventoryTypeAttributes): number;
    public emAlphaDamageActual: (ship: Wafle.Ship, charge: Wafle.InventoryTypeAttributes) => number;
    public explosiveAlphaDamageActual: (ship: Wafle.Ship, charge: Wafle.InventoryTypeAttributes) => number;
    public kineticAlphaDamageActual: (ship: Wafle.Ship, charge: Wafle.InventoryTypeAttributes) => number;
    public thermalAlphaDamageActual: (ship: Wafle.Ship, charge: Wafle.InventoryTypeAttributes) => number;
    /** EM damage in HP */
    ...
    public damageMultiplierForModule(theAttackingModule: Wafle.InventoryTypeAttributes): number;
}
